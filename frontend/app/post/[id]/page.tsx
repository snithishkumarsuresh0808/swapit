                    ...
                    {post.images.map((imageObj) => (
                      <div key={imageObj.id} className="relative group">
                        <img
                          ...
                          className="w-full h-32 object-cover rounded border border-gray-200 bg-gray-100"
                          onError={(e) => {
                        ...
                        />
                        <button
                          onClick={() => window.open(imageObj.image, '_blank')}
                          className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-30 transition-opacity flex items-center justify-center opacity-0 group-hover:opacity-100"
                        >
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {post.videos.map((videoObj) => (
                      <div key={videoObj.id} className="relative">
                        <video
                          controls
                          src={videoObj.video}
                          ...
                          onError={(e) => {
                            ...
                            console.error('Video load error:', videoObj.video);
                          }}
                        >
